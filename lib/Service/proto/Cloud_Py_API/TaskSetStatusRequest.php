 ...
 *No reply.
 *
 * Generated from protobuf message <code>Cloud_Py_API.TaskSetStatusRequest</code>
 */
class TaskSetStatusRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.Cloud_Py_API.taskStatus st_code = 1;</code>
     */
    protected $st_code = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Cloud_Py_API\taskStatus::class);
        $this->st_code = $var;
