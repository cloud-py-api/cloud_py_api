...
/**
 * Generated from protobuf message <code>InitTask.ConfigOptions</code>
 */
class ConfigOptions extends \Google\Protobuf\Internal\Message
{
    /**
...
class_alias(ConfigOptions::class, \InitTask_ConfigOptions::class);
