OC.L10N.register(
    ...
    "Maximum file size (in GBytes) for requesting from php core. Used when file is hosted on remote NC instance or have encrypted flag. Must be less than total available RAM size." : "Tamaño máximo del archivo (en GBytes) para peticiones desde el núcleo php. Se utiliza cuando el archivo se aloja en una instancia NC remota o tiene el indicador de cfirado. Debe ser menor que el tamaño total de RAM disponible.",
