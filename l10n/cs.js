OC.L10N.register(
    ...
    "Maximum file size (in GBytes) for requesting from php core. Used when file is hosted on remote NC instance or have encrypted flag. Must be less than total available RAM size." : "Nejvyšší nastavená umožněná velikost (v gigabajtech) pro požadavky od paměti php. Použito pokud je soubor hostován na vzdálené instanci Nextcloud nebo má příznak šifrováno. Je třeba, aby bylo menší než celková dostupné velikost operační paměti.",
